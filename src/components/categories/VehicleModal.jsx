...
const VehicleModal = ({ vehicle, onSave, onClose, isLoading, error }) => {
    ...
    return (
        <div className="modal-overlay">
            <div className="modal-content">
                <h2>{vehicle ? 'Voertuig Wijzigen' : 'Voertuig Toevoegen'}</h2>
                <form onSubmit={handleSubmit}>
                    <div className="form-group">
                        ...
                        <input
                            ...
                            required
                        />
                        <small>Voer kenteken in zonder streepjes</small>
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            required
                        />
                        <small>Huidige kilometerstand van het voertuig</small>
                    </div>
